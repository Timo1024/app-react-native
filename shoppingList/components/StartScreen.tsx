...
const tags = ['Other', 'University', 'Shopping Lists', 'Important'];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topRow}>
        ...
        <TouchableOpacity onPress={() => console.log("Settings pressed")}>
            <Svg width="25" height="25" fill="none" viewBox="0 0 21 21" transform="translate(0, 1)">
      ...
      <View style={styles.tagsRow}>
        ...
        <TouchableOpacity key={"active"} style={[styles.tag, styles.selectedTag]}>
            <Text style={[styles.tagText, styles.selectedTagText]}>{"active"}</Text>
          </TouchableOpacity>
      </View>
        ...
        {todoLists.map((list, index) => (
          <TouchableOpacity key={index} style={styles.list}>
            {/* <View style={styles.list}> */}
              <Svg width="18" height="18" fill="none" viewBox="0 0 16 16" transform="translate(0, 1)">
